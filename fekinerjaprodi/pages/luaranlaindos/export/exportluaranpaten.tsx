...
export default function exportluaranpaten() {
  ...
  const tampildata = (tahun) => {
    axios({
      ...
      .then(function (response) {
        const { luaransatu } = response.data;

        setdataLuarans(luaransatu);
        console.log(luaransatu);
      })
      .catch(function (err) {
        console.log("gagal");
        console.log(err.response);
                ...
                <div className="card">
                  <div className="card-header pb-0">
                    <div className="d-flex align-items-center">
                      <h4>
                        Luaran Penelitian/PkM Lainnya oleh DTPS (Bagian 1)
                      </h4>
                    </div>
                  </div>
                      ...
                      <div className="col-12 d-flex flex-row-reverse">
                        {dataLuarans && (
                          <ReactHTMLTableToExcel
                            ...
                            table="tableLuaranPaten"
                            filename={`tabelLuaranPaten_TH${dataSelectTahun}`}
                            sheet="3b7-1"
                    ...
                    <div className="row">
                      <div className="card-body p-3">
                        <div className="table-responsive p-0">
                          ...
                          `}</style>
                          <table id="tableLuaranPaten" border={1}>
                            <thead>
                              <tr>
                                <td rowSpan={1}>No</td>
