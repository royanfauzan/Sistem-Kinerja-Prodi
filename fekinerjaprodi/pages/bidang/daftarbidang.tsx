...
export default function daftarbidang() {
  ...
  const tambahbidang = () => {
    MySwal.fire({
      ...
      if (result.value) {
        // <-- if confirmed
        router.push(`/bidang/inputbidang`);
      }
    });
  };
  ...
  const exportbidang = () => {
    MySwal.fire({
      ...
      if (result.value) {
        // <-- if confirmed
        router.push(`/bidang/exportbidang/export_bidang`);
      }
    });
  };
  ...
  const editbidang = (id) => {
    MySwal.fire({
      ...
      if (result.value) {
        // <-- if confirmed
        router.push(`/bidang/edit/${id}`);
      }
    });
  };

  const deletebidang = (id) => {
    MySwal.fire({
