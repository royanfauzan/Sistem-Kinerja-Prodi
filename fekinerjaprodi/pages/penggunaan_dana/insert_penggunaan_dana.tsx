...
export default function input_penggunaan_dana() {
  ...
  const submitForm = async (event) => {
    ...
    formData.append("Biaya_Investasi_Prasarana_Prodi", event.target.Biaya_Investasi_Prasarana_Prodi.value);
    formData.append("Biaya_Investasi_Prasarana_UPPS", event.target.Biaya_Investasi_Prasarana_UPPS.value);
    formData.append("Biaya_Investasi_Sarana_Prodi", event.target.Biaya_Investasi_Sarana_Prodi.value);
    formData.append("Biaya_Investasi_Sarana_UPPS", event.target.Biaya_Investasi_Sarana_UPPS.value);
    formData.append("Biaya_Investasi_SDM_Prodi", event.target.Biaya_Investasi_SDM_Prodi.value);
    formData.append("Biaya_Investasi_SDM_UPPS", event.target.Biaya_Investasi_SDM_UPPS.value);
    formData.append("Biaya_Operasional_Kemahasiswaan_Prodi", event.target.Biaya_Operasional_Kemahasiswaan_Prodi.value);
    formData.append("Biaya_Operasional_Kemahasiswaan_UPPS", event.target.Biaya_Operasional_Kemahasiswaan_UPPS.value);
    formData.append("Biaya_Operasional_Pembelajaran_Prodi", event.target.Biaya_Operasional_Pembelajaran_Prodi.value);
    formData.append("Biaya_Operasional_Pembelajaran_UPPS", event.target.Biaya_Operasional_Pembelajaran_UPPS.value);
    formData.append("Biaya_Operasional_TidakLangsung_Prodi", event.target.Biaya_Operasional_TidakLangsung_Prodi.value);
    formData.append("Biaya_Operasional_TidakLangsung_UPPS", event.target.Biaya_Operasional_TidakLangsung_UPPS.value);
    formData.append("Biaya_Tenaga_Kependidikan_Prodi", event.target.Biaya_Tenaga_Kependidikan_Prodi.value);
    formData.append("Biaya_Tenaga_Kependidikan_UPPS", event.target.Biaya_Tenaga_Kependidikan_UPPS.value);
