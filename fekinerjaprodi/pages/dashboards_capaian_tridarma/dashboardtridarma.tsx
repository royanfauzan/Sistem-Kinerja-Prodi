        ...
        <LayoutForm>
          ...
          <div className="col-12">
              ...
              <div className="col-4 mt-3">
                <div className="card">
                  <div className="card-body">
                    <h6 className="card-title">Data Waktu Tunggu Lulusan</h6>
                    <p className="card-text">
                      With supporting text below as a natural lead-in to
                      additional content.
                    </p>
                    <a href="/waktutunggu/daftarwaktu" className="btn btn-primary">
                      Kelola Data
                    </a>
                  </div>
                </div>
              ...
              <div className="col-4 mt-3">
                <div className="card">
                  <div className="card-body">
                    <h6 className="card-title">Data Kesesuaian Bidang Kerja</h6>
                    <p className="card-text">
                      With supporting text below as a natural lead-in to
                      additional content.
                    </p>
                    <a href="/bidang/daftarbidang" className="btn btn-primary">
                      Kelola Data
                    </a>
                  </div>
                </div>
              ...
              <div className="col-4 mt-3">
                <div className="card">
                  <div className="card-body">
                    <h6 className="card-title">Data Tempat Kerja Lulusan</h6>
                    <p className="card-text">
                      With supporting text below as a natural lead-in to
                      additional content.
                    </p>
                    <a href="/tempat/daftartempat" className="btn btn-primary">
                      Kelola Data
                    </a>
                  </div>
                </div>
              ...
              <div className="col-4 mt-3">
                <div className="card">
                  <div className="card-body">
                    <h6 className="card-title">Data Kepuasan Pengguna Lulusan</h6>
                    <p className="card-text">
                      With supporting text below as a natural lead-in to
                      additional content.
                    </p>
                    <a href="/kepuasan_LLS/daftar_kepuasan_lls" className="btn btn-primary">
                      Kelola Data
                    </a>
                  </div>
                </div>
              ...
              <div className="col-4 mt-3">
                <div className="card">
                  <div className="card-body">
                    ...
                    <a href="/luaran/daftarluaran" className="btn btn-primary">
                      Kelola Data
                    </a>
                  </div>
                </div>
              ...
              <div className="col-4 mt-3">
                <div className="card">
                  <div className="card-body">
                    ...
                    <a href="/pagelaran/daftarpagelaran" className="btn btn-primary">
                      Kelola Data
                    </a>
                  </div>
                </div>
              ...
              <div className="col-4 mt-3">
                <div className="card">
                  <div className="card-body">
                    ...
                    <a href="/seminar/daftarseminar" className="btn btn-primary">
                      Kelola Data
                    </a>
                  </div>
                </div>
              ...
              <div className="col-4 mt-3">
                <div className="card">
                  <div className="card-body">
                    ...
                    <a href="/masastudi/daftarmasastudi" className="btn btn-primary">
                      Kelola Data
                    </a>
                  </div>
                </div>
              ...
              <div className="col-4 mt-3">
                <div className="card">
                  <div className="card-body">
                    ...
                    <a href="/produkMHS/daftarprodukmhs" className="btn btn-primary">
                      Kelola Data
                    </a>
                  </div>
                </div>
