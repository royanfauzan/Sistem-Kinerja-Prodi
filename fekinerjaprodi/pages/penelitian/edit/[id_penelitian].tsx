...
export async function getServerSideProps(context) {
  ...
  //http request
  const req  = await axios.get(`http://127.0.0.1:8000/api/tampil_Penelitian/${context.query.id_penelitian}`)
...
export default function update_datapenelitian(props) {
  ...
  const submitForm = async (event) => {
    ...
    axios({
      method: "post",
      url: `http://127.0.0.1:8000/api/Penelitian_Update/${datapenelitian.id}`+`?_method=PUT`,
      data: formData,
      headers: {
                ...
                <div className="card">
                  <div className="card-header pb-0">
                    <div className="d-flex align-items-center">
                      <p className="mb-0">Edit Data Penelitian</p>
                      <button
                  ...
                  <div className="card-body">
                    <p className="text-uppercase text-sm"> PENELITIAN </p>
                    <div className="row">
                    ...
                    <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                          defaultValue={datapenelitian.tema_sesuai_roadmap}
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                           defaultValue={datapenelitian.judul}
                            className="form-control"
                            type="text"
                       ...
                       <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                          defaultValue={datapenelitian.tahun}
                            className="form-control"
                            type="text"
                            placeholder="Tahun"
                            id="tahun"
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                          defaultValue={datapenelitian.sumber_dana_PT_mandiri}
                            className="form-control"
                            type="text"
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                          defaultValue={datapenelitian.dana_PT_Mandiri}
                            className="form-control"
                            type="text"
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                          defaultValue={datapenelitian.sumber_dalam_negri}
                            className="form-control"
                            type="text"
                       ...
                       <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                           defaultValue={datapenelitian.dana_dalam_negri}
                            className="form-control"
                            type="text"
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                           defaultValue={datapenelitian.sumber_luar_negri}
                            className="form-control"
                            type="text"
                       ...
                       <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                           defaultValue={datapenelitian.dana_luar_negri}
                            className="form-control"
                            type="text"
