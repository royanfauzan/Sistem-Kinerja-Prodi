                  ...
                  <div className="card-body">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-12">
                        <div className="form-group">
                          <label htmlFor="mahasiswa_aktif" className="form-control-label">
                           Mahasiswa Aktif
                          </label>
                          <input
                            className="form-control"
                      ...
                      <div className="col-md-12">
                        <div className="form-group">
                          <label htmlFor="mahasiswa_fulltime" className="form-control-label">
                      ...
                      <div className="col-md-12">
                        <div className="form-group">
                          <label htmlFor="mahasiswa_parttime" className="form-control-label">
