...
export default function tabelrekognisi() {
  ...
  const pengambilData = async () => {
    ...
    axios({
      method: "get",
      url: "http://127.0.0.1:8000/api/search_rekognisidsn",
  ...
  const searchdata = async (e) => {
    const lgToken = localStorage.getItem("token");
    if (e.target.value == "") {
      const req = await axios.get(`http://127.0.0.1:8000/api/search_rekognisidsn/`, {
        headers: {
      ...
      const req = await axios.get(
        `http://127.0.0.1:8000/api/search_rekognisidsn/${e.target.value}`, {
          headers: {
            Authorization: `Bearer ${lgToken}`
          }
        });
                    ...
                    <div className="row justify-content-between mb-4">
                      ...
                      <div className="col-6">
                        <div className="row">
                          ...
                          <Link href={`/rekognisi/inputrekognisidsn/`}>
