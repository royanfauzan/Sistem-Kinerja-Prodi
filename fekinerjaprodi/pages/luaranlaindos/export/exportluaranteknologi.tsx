...
export default function exportluaranteknologi() {
  ...
  const tampildata = (tahun) => {
    axios({
      ...
      .then(function (response) {
        const { luarantiga } = response.data;

        setdataLuarans(luarantiga);
        console.log(luarantiga);
      })
      .catch(function (err) {
        console.log("gagal");
        console.log(err.response);
                ...
                <div className="card">
                  <div className="card-header pb-0">
                    <div className="d-flex align-items-center">
                      <h4>
                        Luaran Penelitian/PkM Lainnya oleh DTPS (Bagian 3)
                      </h4>
                    </div>
                  </div>
                      ...
                      <div className="col-12 d-flex flex-row-reverse">
                        {dataLuarans && (
                          <ReactHTMLTableToExcel
                            ...
                            table="tableTeknologi"
                            filename={`tabelTeknologi_TH${dataSelectTahun}`}
                            sheet="3b7-3"
                    ...
                    <div className="row">
                      <div className="card-body p-3">
                        <div className="table-responsive p-0">
                          ...
                          `}</style>
                          <table id="tableTeknologi" border={1}>
                            <thead>
                              <tr>
                                <td rowSpan={1}>No</td>
                                    ...
                                    <tr className={`text-start`}>
                                      ...
                                      <td className="align-middle text-sm">
                                        <p className="text-xs font-weight-bold mb-0 pe-3 text-start text-wrap">
                                          ...
                                          Tersertifikasi), Karya Seni, Rekayasa
                                          Sosial
                                        </p>
                                      </td>
                                    </tr>
