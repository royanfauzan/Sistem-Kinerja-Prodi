                    ...
                    <div className="row m-0 p-0">
                      ...
                      <div className="col-12 m-0 p-0">
                        <CardSertif judul={"Sertifikat Kompetensi"}>
                          {userDosen &&
                            (
                              userDosen.serkoms.length ? userDosen.serkoms.map((serkom,indx)=>{
                                return(
                                <ListCardSertif
                                key={serkom.id+''+indx}
                                  judul={serkom.nomor_sertifikat}
                                  halamanEdit={`/profildetail/sertifikatkompetensi/${serkom.profil_dosen_id}`}
                                  halaman={
                                    apiurl + serkom.file_bukti
                                  }
                                  icon={`bi bi-patch-check`}
                                />
                                )
